...
export function buildReportHtml(data: ReportSnapshot) {
  ...
  @page{size:A4 landscape;margin:9mm}*{box-sizing:border-box}body{margin:0;background:#eef6f1;color:#173d2d;font:11px Arial,sans-serif}.wrap{max-width:1120px;margin:auto;padding:18px}.btn-print{position:fixed;right:18px;top:14px;border:0;border-radius:8px;padding:9px 14px;background:#1b4332;color:#fff;font-weight:700;cursor:pointer}.hdr{background:#fff;border:1px solid #cfe7d7;border-top:5px solid #2d6a4f;border-radius:11px;padding:16px}.hdr-top{display:flex;justify-content:space-between;gap:22px}.org{font-weight:800;font-size:20px;letter-spacing:.2px}.sub{color:#5a8272;margin-top:3px}.badge-report{display:inline-block;background:#e8f5ee;color:#2d6a4f;border-radius:99px;padding:5px 10px;font-weight:700}.meta-grid{display:grid;grid-template-columns:repeat(5,1fr);gap:8px;margin-top:14px}.meta{border-top:1px solid #d6efd8;padding-top:8px}.lbl{font-size:9px;text-transform:uppercase;color:#759788;letter-spacing:.5px}.val{font-weight:700;margin-top:3px}.progresses{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:13px}.progress{background:#f4faf7;border-radius:8px;padding:10px}.progress-row{display:flex;justify-content:space-between;gap:10px;font-weight:700}.bar{height:8px;background:#dcece2;border-radius:99px;overflow:hidden;margin-top:7px}.fill{height:100%;background:#52b788;border-radius:99px}.fill.gold{background:#d4a72c}.cards{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin:12px 0}.card{background:#fff;border:1px solid #d6efd8;border-radius:9px;padding:11px}.card .v{display:block;font-size:17px;font-weight:800;margin-top:5px;color:#1b4332}.section{background:#fff;border:1px solid #d6efd8;border-radius:10px;margin:12px 0;break-inside:avoid;overflow:hidden}.sec-head{display:flex;align-items:center;gap:9px;padding:10px 12px;background:#e8f5ee}.sec-num{display:grid;place-items:center;width:22px;height:22px;border-radius:50%;background:#2d6a4f;color:#fff;font-weight:800}.sec-title{font-size:13px;font-weight:800}.sec-sub{margin-left:auto;color:#5a8272}.sec-body{padding:11px}.visit-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:10px}.vcard{border:1px solid #d6efd8;border-radius:8px;padding:9px;background:#f9fcfa}.vcard-hunter{border-color:#52b788;background:#eef9f2}.figs{display:grid;grid-template-columns:repeat(4,1fr);gap:5px;margin-top:7px}.fig{text-align:center;background:#fff;border-radius:5px;padding:5px}.fig b{display:block;font-size:14px}table{width:100%;border-collapse:collapse}th{background:#eef7f1;color:#456c5c;text-align:left;font-size:9px;text-transform:uppercase}th,td{padding:6px;border:1px solid #d6efd8;vertical-align:top}.num{text-align:right}.total td{font-weight:800;background:#f4faf7}.empty{text-align:center;color:#759788}.badge{display:inline-block;padding:2px 6px;border-radius:99px;background:#e8f5ee;color:#2d6a4f;font-weight:700}.footer{text-align:center;color:#759788;margin:13px 0 3px;font-size:9px}@media(max-width:760px){.meta-grid,.progresses,.cards,.visit-grid{grid-template-columns:1fr 1fr}.hdr-top{display:block}}@media print{body{background:#fff}.wrap{padding:0}.btn-print{display:none}}
