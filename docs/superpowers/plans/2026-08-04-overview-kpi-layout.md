...
Give both KPI card components the same full-height minimum size, change the KPI grid to one/two/five columns, and delete only the donut block and unused Recharts symbols.
